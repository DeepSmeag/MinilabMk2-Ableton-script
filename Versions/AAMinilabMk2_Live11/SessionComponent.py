...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MiniLab_mkII\SessionComponent.py
...
class SessionComponent(SessionComponentBase):
    ...
    def set_clip_slot_leds(self, leds):
        ...
        return
# okay decompiling .\SessionComponent.pyc
